...
## [2.3.0](https://github.com/entrostat/git-auto-merger/compare/v2.2.0...v2.3.0) (2023-06-25)


### Features

* **email:** Updated the message to include the base branch so that it makes more sense ([01e01ed](https://github.com/entrostat/git-auto-merger/commit/01e01edb6ee6096523f4f9b7c35f34c905240c93))

## [2.2.0](https://github.com/entrostat/git-auto-merger/compare/v2.1.0...v2.2.0) (2023-06-25)


### Features

* **email:** Added a maximum number of lines to concatenate by to ensure that we don't overload information ([0bf6c8a](https://github.com/entrostat/git-auto-merger/commit/0bf6c8a8e492b788e836c5874615a1ad01863b09))

## [2.1.0](https://github.com/entrostat/git-auto-merger/compare/v2.0.13...v2.1.0) (2023-06-25)


### Features

* **logging:** Only output the first and last 20 lines of errors if there are long lists ([05ff6f2](https://github.com/entrostat/git-auto-merger/commit/05ff6f2321a16a151f855b8ee4be1c9b096a7209))

### [2.0.13](https://github.com/entrostat/git-auto-merger/compare/v2.0.12...v2.0.13) (2023-06-25)


### Bug Fixes

* **logging:** Don't output all of the issues, just the first 20 and last 20 lines ([554c0fa](https://github.com/entrostat/git-auto-merger/commit/554c0faa6e09ea0d33963e15557e891d01f5deb6))
