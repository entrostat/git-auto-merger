...
git-auto-merger/1.5.1 linux-x64 node-v16.15.0
...
_See code: [dist/commands/merge.ts](https://github.com/entrostat/git-auto-merger/blob/v1.5.1/dist/commands/merge.ts)_
