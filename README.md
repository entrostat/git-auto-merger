...
git-auto-merger/2.0.3 linux-x64 node-v16.19.0
...
_See code: [dist/commands/merge.ts](https://github.com/entrostat/git-auto-merger/blob/v2.0.3/dist/commands/merge.ts)_
