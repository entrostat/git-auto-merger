...
git-auto-merge/1.0.2 linux-x64 node-v16.15.0
...
_See code: [dist/commands/merge.ts](https://github.com/entrostat/git-auto-merge/blob/v1.0.2/dist/commands/merge.ts)_
